const climbsData = { climbs:
   [ { cliff: 'Old Man of Stoer',
     ...
     { cliff: 'Aiguille Dibona',
       ...
       approchDifficulty: 2,
       rock: 'Granite',
       intro: 'The picturesque peak of Aiguille Dibona was re-named (formerly: Pain de Sucre du Soreiller) after Italian mountaineer Angelo Dibona after the first accent in 1913 with Guido Mayer. The route Visite Obligatoire or Obligatory Visit in English wasn’t climbed until 1988. This is a long, sustained route has mixed bolted and traditional protection. The peak finishes at an altitude just over 3,000m. Although the bottom half contains the technically hardest moves, the route doesn’t let up much. Its graded f6a+. Escape is much harder after the 8th pitch.',
       approach: null,
       incline: null,
       face: 'S' } ] };
