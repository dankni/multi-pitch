const guideBooks = { books:
   [ { climbId: 2,
     ...
     { climbId: 1,
       ...
       pg: 266,
       description:
        'A brilliant book covering such a wide and varied set of crags in the north of Scotland. The section on The Old Man of Stoer Routes is good. The images of longer routes can be a bit small at other crags thou.',
     ...
     { climbId: 7,
       ...
       pg: 191,
       description:
        'North wales has pleanty of Trad climbs above 50m. This book covers a good selection of climbs from a good selection of cliffs, including a variety of routes up the Idwal Slabs.',
       imgURL: 'img/guidebooks/north-wales-climbs.jpg',
       link: null,
       rrp: 24.99,
       guidePrice: 21 },
     ...
     { climbId: 19,
       ...
       pg: '?',
       description:
        'The Canadian Rock: Select Climbs of the West guide documents more than 1200 rock climbs across Western Canada, and in full-colour brings together into a single collection the best climbs in Western Canada, from Squamish to Lake Louise, to the Ghost River Valley.',
