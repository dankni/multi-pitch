const climbsData = { climbs:
   [ { cliff: 'Old Man of Stoer',
     ...
     { cliff: 'Bosigran',
       ...
       rock: 'Granite',
       intro:
        'A classic route on the justifiably popular Bow Wall area of Bosigran. With an easy approch and acessible grade on a cliff sourounded by both harder and easier climbs. Check out Ledge Climb if you want easier or Little Brown Jug if you want to go harder.',
       approach:
     ...
     { cliff: 'Sass Pordoi',
       ...
       approach:
        'Its possible to park at Ristorante Pian Schiavaneis (46.503278,11.802140).From their head North and slihtly east to Sass Pordoi. Start 50m left of the prominent black streak, directly below the huge boulder on the upper ledge. Climb easy scree and rocks to a scree basin.',
       incline: 'Vertical',
       face: null },
     { cliff: 'Cwm Idwal',
       status: 'publish',
     ...
     { cliff: 'Meadinha',
       ...
       approach:
        'Park in the nearby village of Peneda and Meadinha should be clearly visible a short walk up the hill.',
       incline: 'Vertical',
       face: null },
     ...
     { cliff: 'Chair Ladder',
       ...
       approach:
        'There is paid parking in Porthgwarra and a path that leads to the coastguard lookout which is directly above the sea cliff. There is an option to abseil in on the east side of the crag, or you can scramble down via the west side of Zwarn Rinny. This scramble down approach should be avoided at high tide.',
       incline: 'Slab & Vertical',
       face: 'SW' },
     ...
     { cliff: 'Lliwedd',
       ...
       approach:
        'From Pen Y Pass,  take the Miners track to the first lake and the rangers hut where a left turn takes you up towards the Lliwedd and away from the tarmacked tracks.',
       incline: 'Slab',
       face: 'N' },
     { cliff: 'Stetind',
       status: 'publish',
     ...
     { cliff: 'Scafell',
       ...
       approach:
        'Best approached from Wasdale. Allow an hour to hike uphill to the crag.',
       incline: null,
       face: null },
